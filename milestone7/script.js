const hamburger = document.querySelector('#hamburger');
    ...
    function renderRoutes(data) {
        const gallery = document.querySelector('#routes-panel');
        gallery.innerHTML = '';
    ...
    document.querySelector('#search').addEventListener('focus', function() {
        document.querySelector('#routes-panel').classList.remove('hidden');
    })

    document.querySelector('#search').addEventListener('blur', function() {
        document.querySelector('#routes-panel').classList.add('hidden');
    })